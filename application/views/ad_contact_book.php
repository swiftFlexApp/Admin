    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Contact Book</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header bg-secondary">
                <h3 class="card-title">Add Contact Book Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/save_contact_book" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                 
                  <div class="col-md-6 col-sm-6">
                    <label for="title">Name <span class="strdngr">*</span></label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" required>
                  </div>

                  <div class="col-md-6 col-sm-6">
                    <label for="title">Phone No 1 <span class="strdngr">*</span></label>
                    <input type="number" class="form-control" id="contact" name="contact" placeholder="Phone No 1" required minlength="11" maxlength="11">
                  </div>

                  <div class="col-md-6 col-sm-6">
                    <label for="title">Phone No 2</label>
                    <input type="number" class="form-control" id="contact2" name="contact2" placeholder="Phone No 2" minlength="11" maxlength="11">
                  </div>

                  <div class="col-md-6 col-sm-6">
                    <label for="title">Phone No 3</label>
                    <input type="number" class="form-control" id="contact3" name="contact3" placeholder="Phone No 3"  minlength="11" maxlength="11">
                  </div>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <label for="title">Picture <span class="strdngr">*</span></label>
                ...
                <div class="" align="center">
                  ...
                  <button type="submit" name="btnSend" class="btn btn-primary ">Add Contact Book</button>
                </div>
                <br>
                <!-- /.card-footer -->
              </form>
