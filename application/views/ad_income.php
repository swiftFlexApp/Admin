          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header bg-secondary">
                <h3 class="card-title">Add Income Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/save_income" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <label for="title">Income Heading <span class="strdngr">*</span></label>
                    <input type="text" class="form-control" id="heading" name="heading" placeholder="Income Heading" required>
                  </div>

                  <div class="col-md-6 col-sm-6">
                    <label for="title">Income Amount <span class="strdngr">*</span></label>
                    <input type="number" class="form-control" id="amount" name="amount" placeholder="Income Amount" required>
                  </div>

                  
                  <div class="col-md-12 col-sm-12">
                    <label for="detail">Income Detail</label>
                    <textarea class="form-control" rows="5" id="detail" name="detail" placeholder="Income Detail"></textarea>
                  </div>                
                </div>
                </div>
                <!-- /.card-body -->
                <div class="" align="center">
                  ...
                  <button type="submit" name="btnSend" class="btn btn-primary ">Add Income</button>
                </div>
                <br>
                <!-- /.card-footer -->
              </form>
