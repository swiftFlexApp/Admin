    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">List Dues</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">          
        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header bg-secondary">
              <h3 class="card-title">Pending Recoveries</h3>
       ...
       <tbody>
         ...
         foreach ($result as $s) {
           ...
           <tr>
           <td>
            <a target="_blank" href="<?php echo base_url();?>Welcome/invoice?sale_id=<?php echo $s['sale_id']; ?>">
            <?php echo $s['sale_id']; ?></a></td>
           <td>
            <?php 
           ...
           <td style="color: #f00; font-weight: bold;"><?php echo number_format($s['due']); ?><br>
