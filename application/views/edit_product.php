        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              {
                ?>
                <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/update_product" enctype="multipart/form-data">
                 ...
                 <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                      ...
                      <textarea class="form-control" rows="5" id="product_description" name="product_description" placeholder="Product Description"><?php echo $product['product_description']; ?></textarea>
                    </div>      
                ...
                <div class="" align="center">
                  ...
                  <button type="submit" name="btnSend" class="btn btn-primary ">Update Product</button>
                </div>
                <br>
                <!-- /.card-footer -->
              </form>
