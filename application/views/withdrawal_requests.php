    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Withdrawal Requests</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
               ...
               <tbody>
                ...
                foreach ($data as $transfer) {
                  ...
                  <tr>
                   ...
                   <td><?php echo $transfer['fname']." ".$transfer['lname']; ?>
                   <td><?php echo $transfer['bank_name']; ?>
                   <td><?php echo $transfer['transfer_amount']; ?></td>
                   <td><?php echo $transfer['bank_account_full_name']; ?></td>
                   <td>
                    <?php
                        if($transfer['transfer_status'] === 'pending'){
                    ?>
                        <a href="<?php echo base_url();?>Welcome/approve_w_request/?id=<?php echo $transfer['id']; ?>" class="btn btn-primary btn-xs">
                        <i class="fa fa-eye"></i>
                        Approve
                        </a>
                        <a href="<?php echo base_url();?>Welcome/reject_w_request/?id=<?php echo $transfer['id']; ?>" class="btn btn-danger btn-xs">
                        <i class="fa fa-eye"></i>
                        Reject
                        </a>
                    <?php } else if($transfer['transfer_status'] === 'rejected') { ?>
                        <a href="<?php echo base_url();?>Welcome/approve_w_request/?id=<?php echo $transfer['id']; ?>" class="btn btn-warning btn-xs">
                        <i class="fa fa-eye"></i>
                        Approve
                        </a>
                    <?php } ?>
