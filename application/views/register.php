        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/save_user" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6 col-sm-6">
                      ...
                      <select class="form-control" name="type" required>
                        ...
                        <?php
                        foreach ($roles as $r) { ?>
                        <option value="1"><?php echo $r['role_name']; ?></option>
                        <?php } ?>
                    ...
                    <div class="col-md-6 col-sm-6">
                      <label for="pic">Photo <span class="strdngr">*</span></label>
                      <input type="file" class="form-control" id="pic" name="pic" required>
                    </div>
                    <div class="col-md-12 col-sm-12">
                      <label for="Message">Additional Details</label>
                      <textarea class="form-control" rows="5" id="detail" name="detail" placeholder="Details"></textarea>
                    </div>
                  ...
                  <div class="" align="center">
                    ...
                    <button type="submit" name="btnSend" class="btn btn-primary ">Add User</button>
                  </div>
                  <br>
                  <!-- /.card-footer -->
                </form>
