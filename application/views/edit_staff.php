        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/update_staff" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    <?php
            ...
            ?>
              <input type="hidden" name="staff_id" value="<?php echo $row['staff_id']; ?>">
                  <div class="col-md-4 col-sm-4">
                    ...
                    <input type="text" class="form-control" name="staff_name" placeholder="Employee Name" required value="<?php echo $row['staff_name']; ?>">
                  </div>

                  <div class="col-md-4 col-sm-4">
                    <label for="title">Phone <span class="strdngr">*</span></label>
                    <input type="text" class="form-control" name="staff_phone" placeholder="Phone Number" required value="<?php echo $row['staff_phone']; ?>">
                  </div>

                  <div class="col-md-4 col-sm-4">
                    <label for="title">Salary <span class="strdngr">*</span></label>
                    <input type="text" class="form-control" name="salary" placeholder="0" required value="<?php echo $row['salary']; ?>">
                  </div>

                  <div class="col-md-12 col-sm-12">
                    <label for="detail">Address</label>
                    <textarea class="form-control" rows="5" name="staff_address" placeholder="Address"><?php echo $row['staff_address']; ?></textarea>
                  </div> 
                  <?php } ?>               
                </div>
                </div>
                ...
                <div class="" align="center">
                  ...
                  <button type="submit" name="btnSend" class="btn btn-primary ">Update Employee</button>
                </div>
                <br>
                <!-- /.card-footer -->
              </form>
