...
<head>
  ...
  <title>List Supplier Payment</title>
</head>
    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">List Supplier Payment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header bg-secondary">
                <h3 class="card-title">List Supplier Payment</h3>
               ...
               <tbody>
                ...
                foreach ($result as $p) { ?>
                  ...
                  <tr>
                   ...
                   <td>
                    <?php echo $p['supplier_name']; ?><br>
                    <?php echo $p['supplier_contact']; ?>                     
                   </td>
                   <td><?php echo number_format($p['amount']); ?></td>
                   <td><?php echo $p['ref']; ?><br><?php echo $p['detail']; ?></td>
                   <td>
                    <a href="<?php echo base_url();?>Welcome/edit_supplier_payment?payment_id=<?php echo $p['payment_id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>

                    <a href="<?php echo base_url();?>Welcome/delete_supplier_payment?payment_id=<?php echo $p['payment_id']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i> Delete</a>
                  </td>
                </tr>
                <?php
              } 
