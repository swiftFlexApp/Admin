        ...
        <div class="col-md-12">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Reports/get_attendance" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-4 col-sm-4" >
                    <label for="product">Staff <span class="strdngr">*</span></label>
                  ...
                  <tr>
                   <td>
                    <?php 
                      ...
                      ?></td>
                   <td><?php echo $rp['staff_name']; ?></td> 
                   <td><?php echo $rp['presence']; ?></td>
                </td>
              </tr>
              <?php
            } 
