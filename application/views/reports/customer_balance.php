    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            <h1 class="m-0 text-dark">Customer Balance</h1>
          </div><!-- /.col -->
          <div class="col-sm-9">
        ...
        <div class="col-md-12">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Reports/get_customer_balance" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-4 col-sm-4 ">
                    <label>Customer <span class="strdngr">*</span></label>
          ...
          <div class="card-footer text-muted" id="pp">
            ...
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th colspan="7">
                    <h3 align="center"><?php echo $cstmr[0]['customer_name']; ?></h3>
                    <h6 align="center">
                      <?php
