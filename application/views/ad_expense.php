        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/save_expense" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <label for="title">Expense Heading <span class="strdngr">*</span></label>
                    <input type="text" class="form-control" id="heading" name="heading" placeholder="Expense Heading" required>
                  </div>
                  ...
                  <div class="col-md-12 col-sm-12">
                    ...
                    <textarea class="form-control" rows="5" id="detail" name="detail" placeholder="Expense Detail"></textarea>
                  </div>                
                </div>
                </div>
                <!-- /.card-body -->
                <div class="" align="center">
                  ...
                  <button type="submit" name="btnSend" class="btn btn-primary ">Add Expense</button>
                </div>
                <br>
                <!-- /.card-footer -->
              </form>
