    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Supplier Payment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header bg-secondary">
                <h3 class="card-title">Edit Supplier Payment Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/update_supplier_payment" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="col-md-4 col-sm-4">
                    ...
                    <select name="supplier_id" id="supplier_id" class="form-control select2" required="" style="width: 100%;">
                      <option value="<?php echo $payment[0]['supplier_id']; ?>"><?php echo $payment[0]['supplier_name']; ?></option>
