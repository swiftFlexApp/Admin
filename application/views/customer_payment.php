    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Customer Payment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header bg-secondary">
                <h3 class="card-title">Customer Payment Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Welcome/save_customer_payment" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12">
                    ...
                    <textarea class="form-control" rows="5" id="detail" name="detail" placeholder="Customer Detail"></textarea>
                  </div>                
                </div>
                </div>
                <!-- /.card-body -->
